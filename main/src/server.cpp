...
server::server(const uint16_t port, const std::string &base_path) : m_base_path(base_path),
                                                                    mp_implementation(std::make_unique<server_implementation>())
